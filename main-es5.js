...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var routes = [{
      ...
      loadChildren: function loadChildren() {
        ...
        "./src/app/views/pages/auth/auth.module.ts")).then(function (m) {
          return m.AuthModule;
        });
      }
    }, {
  ...
  function srcAppCoreBoarding_services_resolversGeneralConfigResolverServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _parameters_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../parameters.service */
    "./src/app/core/boarding/_services/parameters.service.ts");
    /* harmony import */


    var _base_services_config_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    ...
    var GeneralConfigResolverService = /*#__PURE__*/function () {
      ...
      _createClass(GeneralConfigResolverService, [{
        ...
        value: function resolve(route, state) {
          ...
          return this.paramsService.GetParameters().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["mergeMap"])(function (crisis) {
            if (crisis) {
              localStorage.setItem(_this.cs.getVarName(), btoa(JSON.stringify(crisis)));
              return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["of"])(crisis);
            } else {
              _this.router.navigate(['/oops']);
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](GeneralConfigResolverService, [{
        ...
        return [{
          type: _parameters_service__WEBPACK_IMPORTED_MODULE_3__["ParametersService"]
        }, {
          type: _base_services_config_service__WEBPACK_IMPORTED_MODULE_4__["ConfigService"]
        }, {
      ...
      _createClass(StatementsComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.parametersService.GetInitialParameters(this.auditService.getAudit()).subscribe(function (data) {
            _this2.LeyendaAutorizacion = data.LeyendaAutorizacion;
          });
        }
      }, {
        key: "close",
